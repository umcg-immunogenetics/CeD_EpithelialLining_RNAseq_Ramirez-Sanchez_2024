...
write.csv(DEG.Pathway, 
          file="./output/tables/enrichments/clusters.Pathway.csv", 
          row.names = F, quote = F)
write.table(DEG.Pathway, 
          file="./output/tables/enrichments/clusters.Pathway.txt", 
          row.names = F, quote = F, sep = "\t")
write.csv(DEG.mf, 
          file="./output/tables/enrichments/clusters.mf.csv", 
          row.names = F, quote = F)
write.csv(DEG.bp, 
          file="./output/tables/enrichments/clusters.bp.csv", 
          row.names = F, quote = F)
write.csv(DEG.cc, 
          file="./output/tables/enrichments/clusters.cc.csv", 
          row.names = F, quote = F)
write.csv(DEG.kegg, 
          file="./output/tables/enrichments/clusters.kegg.csv", 
          row.names = F, quote = F)
write.csv(DEG.gse, 
          file="./output/tables/enrichments/clusters.gse.csv", 
          row.names = F, quote = F)

#Saving enrichment objects
saveRDS(DEG.Pathway, "./output/objects/enrichments/clusters/Pathway.RDS")
saveRDS(DEG.mf, "./output/objects/enrichments/clusters/mf.RDS")
saveRDS(DEG.bp, "./output/objects/enrichments/clusters/bp.RDS")
saveRDS(DEG.cc, "./output/objects/enrichments/clusters/cc.RDS")
saveRDS(DEG.kegg, "./output/objects/enrichments/clusters/kegg.RDS")
saveRDS(DEG.gse, "./output/objects/enrichments/clusters/gse.RDS")

saveRDS(DEG.Pathway.pw, "./output/objects/enrichments/clusters/pw/Pathway.pw.RDS")
saveRDS(DEG.mf.pw.simp, "./output/objects/enrichments/clusters/pw/mf.pw.RDS")
saveRDS(DEG.bp.pw.simp, "./output/objects/enrichments/clusters/pw/bp.pw.RDS")
saveRDS(DEG.cc.pw.simp, "./output/objects/enrichments/clusters/pw/cc.pw.RDS")
saveRDS(DEG.kegg.pw, "./output/objects/enrichments/clusters/pw/kegg.pw.RDS")
saveRDS(DEG.gse.pw, "./output/objects/enrichments/clusters/pw/gse.pw.RDS")
