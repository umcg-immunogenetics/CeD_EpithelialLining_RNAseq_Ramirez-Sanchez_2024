...
enrichment_objects <- import.files(input_folder = "./output/objects/enrichments/DEG/", pattern_files = "\\.RDS")
...
#Saving dotplots
pdf(file = "./output/plots/enrichments_dotplots.pdf", width=7, height=7,  family = "ArialMT")
