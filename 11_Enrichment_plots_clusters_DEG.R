...
enrichment_objects <- import.files(input_folder = "./output/objects/enrichments/DEG_clusters/", pattern_files = "\\.RDS")
...
#Saving dotplots
pdf(file = "./output/plots/enrichments_dotplots_clusters_DEG.pdf", width=6, height=8,  family = "ArialMT")
